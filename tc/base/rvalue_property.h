...
#define RVALUE_THIS_NAMED_OVERLOAD_CONST(METHOD, FUNC) \
	template<typename... Args> constexpr auto METHOD(Args&& ...args) const& return_decltype_xvalue_by_ref_MAYTHROW(FUNC(*this, tc_move_if_owned(args)...)) \
	template<typename... Args> constexpr auto METHOD(Args&& ...args) const&& return_decltype_xvalue_by_ref_MAYTHROW(FUNC(tc_move_always_even_const(*this), tc_move_if_owned(args)...))
...
#define RVALUE_THIS_NAMED_OVERLOAD_MOVABLE(METHOD, FUNC) \
	...
	template<typename... Args> constexpr auto METHOD(Args&& ...args) && return_decltype_xvalue_by_ref_MAYTHROW(FUNC(tc_move_always(*this), tc_move_if_owned(args)...))
...
#define RVALUE_THIS_NAMED_OVERLOAD_MOVABLE_MUTABLE_REF(METHOD, FUNC) \
	...
	template<typename... Args> constexpr auto METHOD(Args&& ...args) & return_decltype_xvalue_by_ref_MAYTHROW(FUNC(*this, tc_move_if_owned(args)...))
