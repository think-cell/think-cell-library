...
namespace no_adl { \
	...
	public: \
		static constexpr bool value = std::is_same<std::true_type, decltype(check<BOOST_PP_SEQ_ENUM(BOOST_PP_SEQ_TRANSFORM(TC_PP_APPLY_MACRO, TC_HAS_EXPR_EXTERNAL_PARAMETER, seqArgs))>(nullptr))>::value; \
	}; \
} \
